...
const addIngredients = ({ingredients, setIngredients, handleSubmitIngredients}) => {
    ...
    return (
        ...
        >
            <div
                className="relative flex flex-col justify-between items-center w-2/6 h-full bg-[#978D84] rounded-lg p-10 gap-y-8 shadow-md shadow-gray-600">
